...
la tabla de idempotencia ([1.13](docs/08-plan-de-desarrollo.md#tarea-1-13)), la tabla `usuarios` ([2.4](docs/08-plan-de-desarrollo.md#tarea-2-4)) y la primera promoción a qa ([1.12](docs/08-plan-de-desarrollo.md#tarea-1-12)), que ya tiene la semilla lista. El
...
| **Base** | [1.12](docs/08-plan-de-desarrollo.md#tarea-1-12) · [1.13](docs/08-plan-de-desarrollo.md#tarea-1-13) · [2.4](docs/08-plan-de-desarrollo.md#tarea-2-4) |
...
- [ ] ⚡ **Poner qa al día** ([1.12](docs/08-plan-de-desarrollo.md#tarea-1-12)) — **dev y qa dejaron de ser iguales**: las migraciones
      ...
      120 % y una anulación cuyo motivo es un espacio en blanco. Promoverlas **es** la [1.12](docs/08-plan-de-desarrollo.md#tarea-1-12), que
      para eso existe: escribir el procedimiento y usarlo por primera vez. La semilla que va con
      ellas ya está lista ([1.11](docs/08-plan-de-desarrollo.md#tarea-1-11)).
