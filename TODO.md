...
código del catálogo ([1.8](docs/08-plan-de-desarrollo.md#tarea-1-8)), que ya tiene de dónde salir: cada restricción se llama como la llama el [04](docs/04-modelo-de-datos.md). En el carril Base siguen la semilla
...
Quedan **94 tareas y 114,5 días de trabajo** de 132 tareas del plan.
