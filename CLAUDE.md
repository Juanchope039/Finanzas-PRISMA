...
`0.9.0`, y detrás se abre la [2.8](docs/08-plan-de-desarrollo.md#tarea-2-8). **Y los dos guardianes de Gerencia dejaron de estar solo
escritos** ([2.5](docs/08-plan-de-desarrollo.md#tarea-2-5)): son lo único que impide que el sistema se quede sin quien lo administre
...
ese proyecto, no aquí. **Y la bitácora ya sabe desde dónde** ([2.9](docs/08-plan-de-desarrollo.md#tarea-2-9)): entrar, no poder entrar y salir
