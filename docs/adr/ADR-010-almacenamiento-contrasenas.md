...
que el sistema nunca guarda (RNF-18, ver [`04-modelo-de-datos.md`](../04-modelo-de-datos.md) §5.4).
...
| Cifrado/hashing propio con seed | Control total | **Rodar tu propia criptografía**: anti-patrón de seguridad; contradice ADR-009; reintroduce hashes en código propio |
